...
# install openvpn
wget http://borneobesthosting.me/autoscript/openvpn.sh && chmod +x openvpn.sh && ./openvpn.sh

# install stunnel4 ssl
wget http://borneobesthosting.me/autoscript/stunnel4.sh && chmod +x stunnel4.sh && ./stunnel4.sh
